...
public class Drive extends SubsystemBase implements Vision.VisionConsumer {
    ...
    LoggedMechanismRoot2d driveMechanismRoot;
    ...
    public void periodic() {
        ...
        // Update gyro alert
        gyroDisconnectedAlert.set(!gyroInputs.connected && Robot.CURRENT_ROBOT_MODE == RobotMode.REAL);
    }
    ...
    /**
     * attempt to load a pathplanner path with the path name, if it fails, print an error message and stack trace to the
     * DS
     */
    ...
    /**
     * attempt to load a pathplanner path with the path name and return that path's start pose, if it fail print an
     * error message and stack trace to the DS
     */
